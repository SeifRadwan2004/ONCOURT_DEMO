...
import { mockAthletes, mockTestSessions, testCategories } from "@/data/mockData";
import {
  Table,
  TableBody,
  TableCell,
...
export default function AthleteProfile() {
  ...
  const athleteId = "a1"; // In a real app, get from URL params or auth context
    ...
    return (
      <AthleteLayout>
        <div className="text-center py-12">
          ...
          <Button onClick={() => navigate("/athlete/dashboard")} className="mt-4">
            Back to Dashboard
          </Button>
        </div>
      </AthleteLayout>
  ...
  // Get all test results for this athlete
  ...
  // Get latest test results grouped by test type
  ...
  // Prepare radar chart data (normalize to 0-100 scale for visualization)
  const radarData = [
    {
      name: "Speed",
      value:
  ...
  // Get test history for selected test
